...
export default function Hero() {
  ...
  const productGifs = [
    "https://images.unsplash.com/photo-1618826411640-d6df44dd3f7a?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3",
    "https://images.unsplash.com/photo-1631643690103-aaa1ad5f0cc9?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3",
    "https://images.unsplash.com/photo-1613483187636-c2024013d54a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3"
  ];
              ...
              <div key={index} className="rounded-xl overflow-hidden shadow-md">
                ...
                <div className="bg-white p-3 text-left">
                  <p className="font-medium text-sm">
                    {index === 0 ? "Multiple Vibration Patterns" : 
                     index === 1 ? "Premium Soft-Touch Material" : 
