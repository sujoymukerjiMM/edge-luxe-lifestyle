  ...
  return <AnimatedGradient className="pt-32 pb-20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
        ...
        delay: 0.2
          ...
          <p className="text-lg md:text-xl text-charcoal/80 max-w-2xl mx-auto mb-10">This bestseller has sold out twice—and it’s flying off the shelves again. Secure yours before it's gone! 🚀</p>
        </motion.div>
